...
| Blocky Characters 2.0 / `character-b.glb` | Kenney | [Blocky Characters](https://kenney.nl/assets/blocky-characters) | CC0 1.0 | GLB | Acht Wachen; Bewegung, Schiessen, Interaktion und Tod; eigene Fraktionsweste |
| Blaster Kit 2.1 / `blaster-e.glb` | Kenney | [Blaster Kit](https://kenney.nl/assets/blaster-kit) | CC0 1.0 | GLB | VELA-7-Sturmgewehr für Spieler und Wachen |
| Blaster Kit 2.1 / `blaster-j.glb` | Kenney | [Blaster Kit](https://kenney.nl/assets/blaster-kit) | CC0 1.0 | GLB | Fiktionaler NOVA-Raketenwerfer |
...
| City Kit Industrial / `detail-tank-large.glb` | Kenney | [City Kit Industrial](https://kenney.nl/assets/city-kit-industrial) | CC0 1.0 | GLB | Drei zerstörbare Tanks, eigene rote Lackierung |
...
[CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/) verlangt keine Namensnennung; wir nennen Kenney trotzdem. Keine Modelle werden hotgelinkt. Externe PNG-Texturen wurden verlustfrei in die jeweiligen GLBs eingebettet. Modelle sind umbenannt und werden zur Laufzeit skaliert; Geometrie und Originalanimationen bleiben erhalten. `inventory.json` enthält pro Datei Quelle, Download-URL, Datum, Dateigrösse und SHA-256 der eingebundenen Version. Die zwölf GLBs belegen zusammen 1.079.184 Bytes. Die Blaster-Lizenz wurde zusätzlich in der Archivdatei `License.txt` geprüft.

Eigene Inhalte: Terrain/Topografie, Traversal-Relais, Brücke, Tankstellen-Blockout, Wingsuit-Membranen, Fallschirm-Blockout, Missionen, Namen, HUD, Fraktionswesten, Wracks, Partikeleffekte und per Web Audio synthetisierte Schuss-/Explosionsgeräusche. Diese sind projektintern entstanden und stammen aus keinem anderen Spiel. Flugausrüstung und Wracks verwenden noch Prototyp-Geometrie.
...
| Treibstofftanks / detail-tank-large | [Kenney City Kit Industrial](https://kenney.nl/assets/city-kit-industrial) | CC0; Archivlizenz abgeglichen | GLB | Mit Health, Explosion und eigenem Wrackzustand eingebunden. |
