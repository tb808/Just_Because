...
const files = [
  ...
  ['blocky-characters','GLB format','character-a.glb','characters/resident-coast.glb'],
  ['blocky-characters','GLB format','character-c.glb','characters/resident-harbor.glb'],
  ['blocky-characters','GLB format','character-e.glb','characters/resident-artisan.glb'],
  ['blocky-characters','GLB format','character-i.glb','characters/resident-scholar.glb'],
  ['blocky-characters','GLB format','character-k.glb','characters/resident-market.glb'],
  ['blocky-characters','GLB format','character-m.glb','characters/resident-ranger.glb'],
  ['blocky-characters','GLB format','character-p.glb','characters/resident-craftsman.glb'],
  ['blocky-characters','GLB format','character-j.glb','characters/guard-officer.glb'],
  ['blocky-characters','GLB format','character-q.glb','characters/guard-agent.glb'],
  ['blocky-characters','GLB format','character-r.glb','characters/guard-scout.glb'],
  ['blaster-kit','GLB format','blaster-e.glb','weapons/rifle.glb'],
  ['blaster-kit','GLB format','blaster-a.glb','weapons/pistol.glb'],
  ['blaster-kit','GLB format','blaster-b.glb','weapons/compact.glb'],
  ['blaster-kit','GLB format','blaster-c.glb','weapons/smg.glb'],
  ['blaster-kit','GLB format','blaster-d.glb','weapons/shotgun.glb'],
  ['blaster-kit','GLB format','blaster-f.glb','weapons/carbine.glb'],
  ['blaster-kit','GLB format','blaster-g.glb','weapons/marksman.glb'],
  ['blaster-kit','GLB format','blaster-i.glb','weapons/heavy.glb'],
